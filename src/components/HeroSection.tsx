...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center px-3 pt-32 md:pb-20 bg-black">
      ...
      <div className="hidden md:block absolute top-36 right-[30%] md:right-[55%] translate-x-[20%] -rotate-8 bg-white/10 border border-white/20 text-[#D2D2D2] px-4 py-1 rounded-full backdrop-blur-sm text-xs md:text-lg font-baloo z-20">
      ...
      <div className="flex flex-col gap-12 md:flex-row justify-between items-center w-full  max-w-6xl">
        <div className="relative gap-12 items-center z-10">
          <div className="md:-space-y-2">
            <h1 className="text-4xl md:text-6xl font-bold leading-tight drop-shadow-[0_3px_10px_rgba(0,0,0,0.6)] font-baloo uppercase">
              The War Against <br /> AI Begins Now
            </h1>

            <p className="md:mt-5 text-white font-baloo text-xs md:text-2xl">
