  ...
  return (
    <section className="relative w-full bg-black text-white py-10 md:py-20 px-6 md:px-0 max-w-6xl mx-auto font-brand">
      ...
      <div className="relative max-w-6xl mx-auto text-center mb-20">
        ...
        <p className="text-[#D2D2D2] font-bold text-xl mt-2">
      ...
      <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-10 md:gap-40 z-0">
        <div>
          ...
          <div className="mt-6 space-y-3">
            ...
            <p className="text-[#D2D2D2] text-md md:text-lg leading-relaxed font-bold">
      ...
      <div className="relative flex justify-center mt-16">
        <button className="flex items-center justify-center gap-3 bg-[#FFB700] cursor-pointer text-black px-8 py-3 rounded-2xl shadow-[0_0_20px_rgba(255,215,0,0.4)] hover:bg-yellow-300 transition font-bold text-lg">
