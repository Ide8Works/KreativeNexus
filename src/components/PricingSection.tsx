...
export default function CreativeRevolutionSection() {
  return (
    <section className="w-full text-white py-10 md:py-20 px-6 relative min-h-screen font-brand">
      <div
      ...
      <div className="w-full h-full  py-0">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#D2D2D2] font-bold text-lg md:text-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative w-full max-w-sm mx-auto bg-black text-center rounded-3xl border border-white p-6 md:px-2 md:py-10 shadow-lg">
              {/* DATE BADGE — TOP LEFT */}
              <div className="absolute top-4 font-bold left-4 px-5 py-2 border-2 border-white rounded-xl text-white text-sm tracking-wide bg-black">
                DEC 1 - 7
              </div>
              ...
              {/* SUBTEXT */}
              <p className="mt-4 text-[#D2D2D2] text-base">
              ...
              <div className="w-full flex justify-center items-end">
                <button className="mt-10 w-fit bg-[#FFB700] text-black text-xl px-4 py-3 rounded-full flex items-center justify-center gap-3 hover:bg-yellow-300 transition-all font-bold">
